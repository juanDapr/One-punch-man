...
<body>
	...
	<section id="banner" background="${pageContext.request.contextPath}/recursos/images/banner.jpg">
		<div class="inner">
			<header>
				<h1>MONSTRUOS</h1>
			</header>
				...
				<tbody>
					<c:forEach items="${m }" var="m">
						<tr>
							<td>${m.id}</td>
							<td>${m.nombre }</td>
							<td>${m.nivelAmenaza}</td>
							
							<td><img src="recursos/images/${m.imagen}" width="80"
