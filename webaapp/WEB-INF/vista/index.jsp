		...
		<tbody>
			<c:forEach items="${lista }" var="lista">
				<tr>
					<td>${lista.id}</td>
					<td>${lista.nombre }</td>
					<td>${lista.habilidad}</td>
					<td>${lista.rango}</td>
					<td><img src="recursos/images/${lista.imagen}" width="80"
						height="80" alt="imagen"></td>
					<td><a href="edit/${lista.id}" class="btn btn-success btn-sm"
						role="button" title="Edit"> <span
							class="glyphicon glyphicon-pencil"></span>editar
					</a> <a href="eliminar/${lista.id}"
