	...
	<div id="main">
		...
		<section class="wrapper style1">
			<div class="inner">
				...
				<form action="guardarmonstruo" method="post" enctype="multipart/form-data">

					<div class="flex flex-2">
						<div class="video col">
							
							Nombre del monstruo: <input type="text" class="form-control"
								id="nombre" name="nombre" placeholder="Nombre" required><br />
							
						</div>
						<div class="video col">
							Nivel de amenaza: <select id="nivelAmenaza" name="nivelAmenaza" required>
								<option value="">- Nivel de Amenaza -</option>
